 ...
 <div class="am-u-sm-12 am-u-md-3">
		<div class="am-input-group am-input-group-sm">
			<input type="text" class="am-form-field" id="condidtions" value="${condidtions}" onkeypress="if(event.keyCode==13){search.click();return false;}"> <span
				...
				<button class="am-btn am-btn-default" type="button" onclick="javascript:queryinpatient(1)" id="search">搜索</button>
			</span>
		</div>
</div>
<div class="am-g">
		<div class="am-u-sm-12 am-u-md-6">
			<div class="am-btn-toolbar">
				<div class="am-btn-group am-btn-group-xs">
					<button type="button" class="am-btn am-btn-default" onclick="javascript:getsaveinpatient(1)">
...
<div class="am-g">
      ...
      <form class="am-form">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
          <tr>
            <th>病人姓名</th><th>房号</th><th>床位号</th><th>所在科室</th><th>医生姓名</th><th>医嘱</th><th>入院时间</th><th>出院时间</th><th>预交金额</th>
          </tr>
          </thead>
          <tbody>
          <s:iterator value="pb.beanlist" var="inpatient">
          <tr>	
          <td><s:property value="#inpatient.PName"/></td><td><s:property value="#inpatient.hrNo"/></td><td><s:property value="#inpatient.BNo"/></td> 
